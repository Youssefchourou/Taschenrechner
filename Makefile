#############################################################################
# Makefile for building: OUAD_Taschenrechner
# Generated by qmake (3.1) (Qt 5.15.11)
# Project:  OUAD_Taschenrechner.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile OUAD_Taschenrechner.pro
#############################################################################
...
CXXFLAGS      = -pipe -fprofile-arcs -ftest-coverage -O2 -std=gnu++1z -flto -fno-fat-lto-objects -Wall -Wextra -fPIC $(DEFINES)
INCPATH       = -I. -I/home/stud/OUAD_Taschenrechner/extern/googletest/googletest/include -I/home/stud/OUAD_Taschenrechner/extern/googletest/googlemock/include -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = OUAD_Taschenrechner1.0.0
DISTDIR = /home/stud/OUAD_Taschenrechner/.tmp/OUAD_Taschenrechner1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -pipe -fprofile-arcs -ftest-coverage -O2 -std=gnu++1z -flto=2 -fno-fat-lto-objects -fuse-linker-plugin -fPIC
LIBS          = $(SUBLIBS) -L/home/stud/OUAD_Taschenrechner/extern/googletest/build/lib -lgtest -lgtest_main   
AR            = gcc-ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = caculator_test.cpp \
		calculator.cpp \
		main.cpp \
		token.cpp 
OBJECTS       = caculator_test.o \
		calculator.o \
		main.o \
		token.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		OUAD_Taschenrechner.pro calculator.h \
		token.h caculator_test.cpp \
		calculator.cpp \
		main.cpp \
		token.cpp
QMAKE_TARGET  = OUAD_Taschenrechner
DESTDIR       = 
TARGET        = OUAD_Taschenrechner


first: all
####### Build rules

OUAD_Taschenrechner:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: OUAD_Taschenrechner.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/yacc.prf \
		/usr/lib/qt/mkspecs/features/lex.prf \
		OUAD_Taschenrechner.pro
	$(QMAKE) -o Makefile OUAD_Taschenrechner.pro
...
all: Makefile OUAD_Taschenrechner
...
caculator_test.o: caculator_test.cpp calculator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o caculator_test.o caculator_test.cpp
